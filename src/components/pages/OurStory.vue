  ...
  <section class="about relative-pos">
    <div class="container">
        <div class="row txt-uppercase">
          ...
          <div class="col-md-3 col-lg-3 col-xs-12">
            <div class="history-box blue-txt text-center shadow-sm">
              <h3 class="history-title">Core competencies</h3>
              <div class="prod-title-sep"></div>
              <img src="../../assets/correct_content/competence.jpg" class="about-image" />
              <p>creativity<br/>innovation</p>
            </div>
          </div>
          ...
          <div class="col-md-3 col-lg-3 col-xs-12">
            <div class="history-box blue-txt text-center shadow-sm">
              ...
              <div class="prod-title-sep"></div>
              <img src="../../assets/correct_content/integrity.jpg" class="about-image" />
              <p>integrity<br/>leadership</p>
            </div>
          </div>
        </div>
    </div>
